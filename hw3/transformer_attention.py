...
class AttentionQKV(nn.Module):
    ...
    def forward(self, queries, keys, values, mask=None):
        ...
        similarity = queries @ keys.transpose(dim0=-2, dim1=-1) # Compute the similarity according to the QKV formula
        ...
        weights = th.softmax(masked_similarity / th.sqrt(key_dim), dim=-1) # Turn the similarity into a normalized output. Remember that the last dim contains the features
